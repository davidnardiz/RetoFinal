...
public class PublicacionesGuardadas extends javax.swing.JDialog {
    ...
    public PublicacionesGuardadas(Conector conector, JDialog parent, boolean modal, DAO dao, Publicacion publi, Usuario usu, Usuario usuarioPerfil1, Perfil perfil) {
        super(parent, modal);
        this.nosotros = usu;
