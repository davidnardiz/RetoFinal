...
public class PublicacionesEtiquetadas extends javax.swing.JDialog {
    ...
    public PublicacionesEtiquetadas(Conector conector, JDialog parent, boolean modal, DAO dao, Publicacion publi, Usuario usu, Usuario usuarioPerfil1, Perfil perfil) {
        super(parent, modal);
        this.nosotros = usu;
    ...
    private void abrirFoto(String foto) {
        ...
        PublicacionPopUp publiPop = new PublicacionPopUp(conector, paraTi, true, dao, publi, nosotros, usuarioPerfil, perfil);
